  ...
  const heroSoundOn = document.getElementById("hero-sound-on");
  const heroSoundOff = document.getElementById("hero-sound-off");

  document.getElementById("muteBtn").onclick = () => {
    heroVideo.muted = !heroVideo.muted;

    if (heroVideo.muted) {
      heroSoundOn.style.display = "none";
      heroSoundOff.style.display = "block";
    } else {
      heroSoundOn.style.display = "block";
      heroSoundOff.style.display = "none";
    }
  };
